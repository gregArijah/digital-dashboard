                ...
                <div className=''>
                    <p className='font-bold'>IMAGES</p>
                        ...
                        >
                            ...
                            <SwiperSlide><div className='flex flex-col pb-5'><img src='https://drive.google.com/uc?id=1K6Dn_yfwg1sEpZg_OweDc9iqx4IjocZn' className='h-64 mx-auto' /><span className='mx-10 md:mx-20'>Slide 13: The project was basically complete at this point as far as the dashboard goes. However I decided to change the engine to the engine taken from the motorcycle in the picture.</span></div></SwiperSlide>
